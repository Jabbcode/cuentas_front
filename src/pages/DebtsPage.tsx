  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-900">Deudas</h1>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="rounded-lg border border-blue-200 dark:border-blue-700 bg-blue-50 dark:bg-blue-900/20 p-4">
          <p className="text-sm font-medium text-blue-600 dark:text-blue-600">Deudas Activas</p>
        ...
        {overdueDebts.length > 0 && (
          <div className="rounded-lg border border-red-200 dark:border-red-700 bg-red-50 dark:bg-red-900/20 p-4">
            <p className="text-sm font-medium text-red-600 dark:text-red-600">Deudas Vencidas</p>
        ...
        <div className="rounded-lg border border-green-200 dark:border-green-700 bg-green-50 dark:bg-green-900/20 p-4">
          <p className="text-sm font-medium text-green-600 dark:text-green-600">Deudas Pagadas</p>
      ...
      {/* Debts List */}
      {debts.length === 0 ? (
        <div className="rounded-lg border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 p-12 text-center">
          <p className="text-gray-500 dark:text-gray-500">No tienes deudas registradas</p>
        ...
        <>
          ...
          {overdueDebts.length > 0 && (
            <div>
              <h2 className="text-lg font-semibold text-red-600 dark:text-red-600 mb-3">⚠️ Deudas Vencidas</h2>
          ...
          {activeDebts.length > 0 && (
            <div>
              <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-900 mb-3">Deudas Activas</h2>
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          {paidDebts.length > 0 && (
            <div>
              <h2 className="text-lg font-semibold text-green-600 dark:text-green-600 mb-3">✓ Deudas Pagadas</h2>
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                {paidDebts.map((debt) => (
                  <div key={debt.id} className="space-y-3">
                    <DebtCard
