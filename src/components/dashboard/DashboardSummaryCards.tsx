    ...
    <div className="grid grid-cols-2 gap-3 lg:gap-4 lg:grid-cols-4">
      <Card>
        <CardHeader className="flex flex-row items-center justify-between p-3 pb-1 lg:p-6 lg:pb-2">
          ...
          <div className="rounded-full bg-blue-100 p-1.5 lg:p-2 dark:bg-blue-900/30">
            <Wallet className="h-3 w-3 text-blue-600 lg:h-4 lg:w-4 dark:text-blue-400" />
          </div>
        </CardHeader>
        <CardContent className="p-3 pt-0 lg:p-6 lg:pt-0">
          <div className="text-lg font-bold text-gray-900 lg:text-2xl dark:text-gray-50">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between p-3 pb-1 lg:p-6 lg:pb-2">
          ...
          <div className="rounded-full bg-green-100 p-1.5 lg:p-2 dark:bg-green-900/30">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between p-3 pb-1 lg:p-6 lg:pb-2">
          ...
          <div className="rounded-full bg-red-100 p-1.5 lg:p-2 dark:bg-red-900/30">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between p-3 pb-1 lg:p-6 lg:pb-2">
          ...
          <div className={`rounded-full p-1.5 lg:p-2 ${monthlyNet >= 0 ? 'bg-green-100 dark:bg-green-900/30' : 'bg-red-100 dark:bg-red-900/30'}`}>
            {monthlyNet >= 0 ? (
              <TrendingUp className="h-3 w-3 text-green-600 lg:h-4 lg:w-4 dark:text-green-400" />
            ) : (
              <TrendingDown className="h-3 w-3 text-red-600 lg:h-4 lg:w-4 dark:text-red-400" />
