    ...
    return (
      <Card>
        ...
        <CardContent className="p-4 pt-0 lg:p-6 lg:pt-0">
          <div className="flex h-32 items-center justify-center text-sm text-gray-500 dark:text-gray-500 lg:h-48">
            Sin gastos este mes
          </div>
        </CardContent>
      </Card>
            ...
            {categories.slice(0, 5).map((cat, index) => (
              <div key={cat.id} className="flex items-center justify-between text-sm">
                ...
                <div className="text-right">
                  ...
                  <span className="ml-1 text-[10px] text-gray-500 dark:text-gray-500 lg:ml-2 lg:text-xs">({cat.percentage}%)</span>
                </div>
              </div>
            ))}
          </div>
