    ...
    <div ref={containerRef} className="relative">
      ...
      <button
        ...
        className={cn(
          ...
          'dark:border-gray-600 dark:bg-gray-700 dark:hover:border-gray-300 dark:focus:border-blue-600 dark:focus:ring-blue-900/30',
        ...
        {selectedCategory ? (
          <div className="flex items-center gap-2">
            <CategoryIcon
              ...
              size="md"
            />
            <span className="text-gray-900 dark:text-gray-900">{selectedCategory.name}</span>
          </div>
        ) : (
      ...
      {isOpen && (
        <div className="absolute z-50 mt-1 w-full rounded-md border border-gray-200 bg-white py-1 shadow-lg dark:border-gray-600 dark:bg-gray-800">
          <div className="max-h-60 overflow-y-auto">
            {categories.length === 0 ? (
              <div className="px-3 py-2 text-sm text-gray-500 dark:text-gray-500">No hay categorías</div>
            ) : (
              categories.map((category) => (
                <button
                  ...
                  className={cn(
                    ...
                    value === category.id && 'bg-blue-50 dark:bg-blue-600/10'
                  )}
                >
                  <div className="flex items-center gap-2">
                    <CategoryIcon
                      ...
                      size="md"
                    />
                    <span className="text-gray-900 dark:text-gray-900">{category.name}</span>
                  </div>
                  {value === category.id && (
